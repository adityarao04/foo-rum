...
const FeedRichTextContainer: FC<FeedRichTextContainerProps> = ({ content }) => {
    return (
        <div className='w-full flex justify-between items-center'>
            <div className='bg-feed-bg rounded-lg p-1 flex'>
                ...
                <div className="rounded-lg font-medium text-xs p-2 ml-2 cursor-pointer">
                    <img src="/images/text-underline.svg" alt="bold_image"  className='w-[14px] h-[14px]'/>

                </div>
                <div className="rounded-lg font-medium text-xs p-2 ml-2 cursor-pointer">
                    <img src="/images/list-unordered.svg" alt="bold_image"  className='w-[14px] h-[14px]'/>

                </div>
                <div className="rounded-lg font-medium text-xs p-2 ml-2 cursor-pointer">
                    <img src="/images/list-ordered.svg" alt="bold_image"  className='w-[14px] h-[14px]'/>
            ...
            <div className="bg-[#FF000026] rounded-lg h-[40px] w-[40px] flex items-center justify-center cursor-pointer" >
